...
- [Architecture](docs/ARCHITECTURE.md) -- layers, design decisions, file structure
- [Contributing](docs/CONTRIBUTING.md) -- development setup, component template, conventions
